    ...
    <div className="fl-overlay" onClick={onClose} role="dialog" aria-modal="true">
      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                <span style={{ fontSize: '13px', fontWeight: 800, color: 'var(--fl-teal-light)', textTransform: 'uppercase', letterSpacing: '0.04em' }}>
              ...
              <p style={{ fontSize: '13px', color: 'var(--fl-text-secondary)', margin: 0, marginTop: '2px' }}>
          ...
          >
            <RefreshCw size={14} className={isGenerating ? 'fl-spin' : ''} />
            <span>{isGenerating ? 'Synthesizing...' : 'Regenerate'}</span>
          </button>
        </div>

        {generationNotice && (
          <div style={{ padding: '8px 14px', marginBottom: '10px', borderRadius: '6px', backgroundColor: 'rgba(99, 102, 241, 0.2)', fontSize: '13px', color: 'var(--fl-indigo-light)', textAlign: 'center' }}>
            {generationNotice}
          </div>
        )}
